...
declare module "baseui/popover" {
  ...
  export type ACCESSIBILITY_TYPE = {
    none: "none";
    menu: "menu";
    tooltip: "tooltip";
  };

  export type POPOVER_MARGIN = 8;

  export type ARROW_SIZE = 6;

  export type ANIMATE_OUT_TIME = 0;

  export type ANIMATE_IN_TIME = 20;
  export type ARROW_WIDTH = number;
  ...
  export type StatefulContentRenderPropT = (args: {
    close: () => void;
  }) => React.ReactNode;
  ...
  > & {
    children: (
      props: Diff<PopoverPropsT, { children: React.ReactNode }>
    ) => React.ReactNode;
  };
  ...
  export class StatefulPopover extends React.Component<StatefulPopoverPropsT> {}
